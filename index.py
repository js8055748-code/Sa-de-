...
# Usamos /tmp para o banco SQLite (ephemeral, mas funcional para demos/protótipos)
DB_PATH = os.path.join(tempfile.gettempdir(), 'pacientes.db')
...
# ------------------------------------------------------------------
# ROTAS DO FRONT-END (servir HTML da pasta /public)
# ------------------------------------------------------------------
...
# O Vercel importa 'app' diretamente deste módulo
# Não precisa de if __name__ == '__main__' para produção
# Mas mantemos para desenvolvimento local:
